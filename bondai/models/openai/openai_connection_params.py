...
OPENAI_CONNECTION_TYPE = OpenAIConnectionType.AZURE if os.environ.get(OPENAI_CONNECTION_TYPE_ENV_VAR) == 'azure' else OpenAIConnectionType.OPENAI
...
AZURE_OPENAI_GPT35_API_VERSION = os.environ.get(AZURE_OPENAI_GPT35_API_VERSION_ENV_VAR, "2023-07-01-preview")
...
AZURE_OPENAI_GPT4_API_VERSION = os.environ.get(AZURE_OPENAI_GPT4_API_VERSION_ENV_VAR, "2023-07-01-preview")
