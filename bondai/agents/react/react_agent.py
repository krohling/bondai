...
class ReactAgent(Agent):
    ...
    def __init__(self, 
        ...
        Args:
            ...
            llm (LLM, optional): The LLM to use. Defaults to OpenAIModelNames.GPT4_0613.
            fallback_llm (LLM, optional): The fallback LLM to use. Defaults to OpenAILLM(OpenAIModelNames.GPT35_TURBO_0613).
                    ...
                    try:
                        ...
                        if tool_output is dict:
                            if 'output' in tool_output:
                                ...
                                raise AgentException(f"The tool '{selected_tool.name}' did not return a valid response. A Dictionary response must contain an 'output' key.")
