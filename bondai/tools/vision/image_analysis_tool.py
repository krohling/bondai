...
class ImageAnalysisTool(Tool):
    ...
    def run(self, analysis_description: str, image_url: str = None, image_file_path: str = None) -> str:
        if image_url is not None:
            ...
            return self._analyze_image(f"data:image/jpeg;base64,{base64_image}", analysis_description)
        else:
            raise Exception('Either image_url or image_file_path is required. Neither were provided.')
