...
const AgentChat = () => {
  ...
  const createAgent = async () => {
    try {
      ...
      const createAgent = await res.json();
  ...
  const getAgents = async () => {
    try {
      ...
      const getsAgents = await res.json();
      console.log('getsAgents:', getsAgents);
      return getsAgents;
  ...
  return (
    <>
      <div className="flex justify-between flex-grow">
        ...
        <div className="w-3/4 max-w-[600px] flex-grow ml-5 mt-5">
          <h1 className='font-bold text-xl mb-4'>New Task</h1>
          <div className='hidden flex flex-col flex-1 mt-5'>
        ...
        <div className="flex">
          ...
          <div className="flex-grow inline-block w-[50px] text-xs text-right justify-center pt-4 relative z-2">
            <button className="h-[40px] w-[40px] dark:shadow-lg border-l border-t border-b mb-3 bg-neutral-900 hover:bg-neutral-800" onClick={() => handleAgentClick('CFO')}>CFO</button>
            <button className="h-[40px] w-[40px] dark:shadow-lg border-l border-t border-b mb-3 bg-neutral-900 hover:bg-neutral-800" onClick={() => handleAgentClick('CTO')}>CTO</button>
            <button className="h-[40px] w-[45px] mr-[-1px] border-l border-t border-b bg-neutral-950 mb-3" onClick={() => handleAgentClick('CEO')}>CEO</button>
          </div>

          <div className="flex-grow inline-block w-[250px] text-black dark:text-white dark:bg-neutral-950 border-l p-4">
      ...
      <div className='hidden'>
        <div id="chat-panel" className='w-3/4 max-w-[600px] h-full flex flex-col'>
          <h1 className='font-bold text-xl mb-4'>New Task</h1>
        ...
        <div id="agent-panel" className='text-black dark:text-white w-1/4 dark:bg-black/20 fixed border-l right-0 p-2' style={{ height: 'calc(100vh - 64px)', top: '64px' }}>
          <div className='flex-grow'>
            <h2 className='mb-4 flex items-center'>
              <div className='text-sm'>
                {renderAgentState(agentState)} 
